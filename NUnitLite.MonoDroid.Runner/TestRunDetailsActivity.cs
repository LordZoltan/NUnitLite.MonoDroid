...
namespace NUnitLite.MonoDroid
{
	...
	public abstract class TestRunDetailsActivity : Activity
	{
		...
		private View CreateView(TestRunInfo testRunDetails)
		{
			...
			titleTextView.Text = testRunDetails.TestCountDescription;
			...
			descriptionTextView.Text = testRunDetails.TestResult.Message +
					Env.NewLine + Env.NewLine + testRunDetails.TestResult.StackTrace;
		...
		public override bool OnCreateOptionsMenu(IMenu menu)
		{
			...
			return _menuHelper.OnCreateOptionsMenu(menu);
		}
		...
		public override bool OnOptionsItemSelected(IMenuItem item)
		{
			if (base.OnOptionsItemSelected(item))
				return true;
			return _menuHelper.OnOptionsItemSelected(item);
		}
	}
}