...
namespace NUnitLite.MonoDroid
{
	...
	public class TestResultsListAdapter : BaseAdapter
	{
		...
		public override View GetView(int position, View convertView, ViewGroup parent)
		{
			...
			if (tag.CountTextView != null)
				tag.CountTextView.Text = itemContent.IsTestSuite ? itemContent.TestCountDescription : string.Empty;
		...
		private View InflateItemView(TestRunInfo itemContent)
		{
			...
			//layout.LayoutParameters = new AbsListView.LayoutParams(AbsListView.LayoutParams.FillParent, AbsListView.LayoutParams.FillParent);
			...
			if (itemContent.IsTestSuite)
			{
				...
				LinearLayout suiteTextViews = new LinearLayout(_context);
				suiteTextViews.LayoutParameters = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FillParent, LinearLayout.LayoutParams.WrapContent);
				suiteTextViews.Orientation = Orientation.Vertical;
				...
				suiteTextViews.AddView(descriptionView);

				countView = new TextView(_context);
				...
				suiteTextViews.AddView(countView);

				layout.AddView(suiteTextViews);
			}
			else
			{
			...
			layout.Tag = new TestResultViewHolder(indicatorView, descriptionView, countView);
